...
- (void)viewDidLoad
{
    ...
    GameLogic* gameLogic = [GameLogic GetInstance];
    drawTimer = [NSTimer scheduledTimerWithTimeInterval:0.05 target:self selector:@selector(drawGame) userInfo:nil repeats:YES];
    [drawTimer fire];
...
- (void)didRotateFromInterfaceOrientation:(UIInterfaceOrientation)fromInterfaceOrientation
{
    ...
    GameLogic* gameLogic = [GameLogic GetInstance];
    gameLogic.fieldWidth = (int)roundf(width);
